...
Once you have the design read and dials (SKILL.md sections 0 and 1), pick the right foundation. Do not invent CSS for things that have an official package. Do not pretend an aesthetic trend is an official system.

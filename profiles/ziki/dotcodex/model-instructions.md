...
## Git delivery and attribution

- Do not create branches, worktrees, or pull requests.
- When the user explicitly invokes `yolo`, use the `yolo` skill to verify,
  commit, and push directly to the remote default branch.
- When Codex materially contributes to a commit, append this exact line after a
  blank line:

  `Co-authored-by: Codex <noreply@openai.com>`

- Use it as a Git trailer in commit bodies.

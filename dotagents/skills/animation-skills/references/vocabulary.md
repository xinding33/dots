...
- **Perspective:** Controls the strength of the 3D effect. A lower value
  exaggerates depth by moving the viewer closer.
...
- **Mask:** Hides or reveals parts of an element with a shape or gradient. It
  works like `clip-path` but supports soft edges.
...
- **Purposeful animation:** Motion that provides orientation, feedback, or
